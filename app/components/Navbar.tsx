...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-[#1a1a2e] lg:hidden transition-transform duration-300 ease-out z-[70] ${
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-white/5">
          ...
          <a
            href="/#cotizar"
            onClick={handleNavClick}
            className="flex items-center justify-center gap-2 w-full px-5 py-3.5 bg-brand hover:bg-brand-dark text-white font-semibold rounded-none transition-all duration-200 text-xs uppercase tracking-wider"
          >
            Cotizar
            <svg
              className="w-3.5 h-3.5"
