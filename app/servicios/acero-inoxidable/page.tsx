        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-6 leading-[1.1]">
              Acero{" "}
              <span className="text-brand">Inoxidable</span>
            </h1>
            <p className="text-gray-400 leading-relaxed mb-8">
              Barandas, pasamanos, escaleras y cocinas en acero inoxidable con
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {["Acero inoxidable", "Barandas", "Pasamanos", "Escaleras", "Cocinas", "Cepillado espejo"].map((a) => (
          ...
          <ImageGallery
            ...
            extraImages={["img5.jpg", "img6.jpg", "img7.jpg"].map((s) => `/img/services/acero/${s}`)}
