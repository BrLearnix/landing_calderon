      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 lg:px-12 py-16 sm:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-4">
            <div className="aspect-[4/3] rounded-2xl bg-white/5 border border-white/10 shadow-sm flex items-center justify-center">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="aspect-square rounded-xl bg-white/5 border border-white/10 shadow-sm flex items-center justify-center">
