    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3">
          <div
            className="relative animate-chat-bubble bg-white/95 backdrop-blur-sm text-gray-800 text-sm font-medium px-4 py-2.5 rounded-xl shadow-lg border border-white/10 select-none
